...
import com.kcs.community.entity.RefreshEntity;
...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        // Token
        String accessToken = jwtUtil.generateToken("access", username, role, 600000L);
        String refreshToken = jwtUtil.generateToken("refresh", username, role, 86400000L);
